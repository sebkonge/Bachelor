...
#define PWM_PIN 2               // GPIO pin for ESC signal
...
void PID_motor_control_regulator(Accel &accel, Gyro &gyro, DataVal &dataVal, PID &pid, float &current_angle, float Kp, float Ki, float Kd);
